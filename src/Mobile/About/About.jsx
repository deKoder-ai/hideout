  ...
  return (
    <>
      ...
      <h2 className={styles.aboutHead}>
        Where the city's best kept secret is waiting to be uncovered, and the
        good times are always on tap!
      </h2>
      <p className={styles.para}>
        Step into the unassuming entrance, and discover a world of hidden
        delights. At Hideout Ari, we've repurposed an old [insert location] to
        create a sophisticated oasis in the heart of the city. Think exposed
        brick, reclaimed wood, and vintage accents – with a dash of modern
        flair.
      </p>
      <p className={styles.para}>
      ...
      <p className={styles.para}>
        From our globally-inspired small plates to our expertly crafted
        cocktails, every detail at Hideout Ari is designed to make you feel at
        home. Join us for dinner, drinks, or just a night out with friends – and
